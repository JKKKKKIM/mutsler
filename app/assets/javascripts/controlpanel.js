...
$str += '       	<li> <a id="fullwidth" href="" title="" class="selected"> <%= image_tag("style-picker/fullwidth.jpg") %> </a> </li>';
$str += '       	<li> <a id="boxed" href="" title=""> <%= image_tag("style-picker/boxed.jpg") %> </a> </li>';
$str += '		</ul>';
